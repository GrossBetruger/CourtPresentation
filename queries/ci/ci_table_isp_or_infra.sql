...
oversold_half_bezeq as (select count(*) from bezeq_ci where bezeq_ci.גבול_עליון::float / bezeq_ci.תכנית::float < 0.5),
oversold_half_bezeq_evening as (select count(*) from bezeq_ci_evening where bezeq_ci_evening.גבול_עליון::float / bezeq_ci_evening.תכנית::float < 0.5),
oversold_third_bezeq as (select count(*) from bezeq_ci where bezeq_ci.גבול_עליון::float / bezeq_ci.תכנית::float < 1./3.),
oversold_third_bezeq_evening as (select count(*) from bezeq_ci_evening where bezeq_ci_evening.גבול_עליון::float / bezeq_ci_evening.תכנית::float < 1./3.),
...
oversold_half_hot_evening as (select count(*) from hot_ci_evening where hot_ci_evening.גבול_עליון::float / hot_ci_evening.תכנית::float < 0.5),
oversold_third_hot as (select count(*) from hot_ci where hot_ci.גבול_עליון::float / hot_ci.תכנית::float < 1./3.),
oversold_third_hot_evening as (select count(*) from hot_ci_evening where hot_ci_evening.גבול_עליון::float / hot_ci_evening.תכנית::float < 1./3.),


number_partner as (select count(distinct partner_ci.שם_משתמש) from partner_ci),
oversold_half_partner as (select count(*) from partner_ci where partner_ci.גבול_עליון::float / partner_ci.תכנית::float < 0.5),
oversold_half_partner_evening as (select count(*) from partner_ci_evening where partner_ci_evening.גבול_עליון::float / partner_ci_evening.תכנית::float < 0.5),
oversold_third_partner as (select count(*) from partner_ci where partner_ci.גבול_עליון::float / partner_ci.תכנית::float < 1./3.),
oversold_third_partner_evening as (select count(*) from partner_ci_evening where partner_ci_evening.גבול_עליון::float / partner_ci_evening.תכנית::float < 1./3.)
